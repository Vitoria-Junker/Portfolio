    ...
    return(
        <>
          <ul className="flex justify-center gap-8 text-pink-3 flex-wrap p-8 pl-16 pr-16 w-4/5">
                <li className="p-2 border w-24 h-24 border-pink-3 transition duration-300 ease-in-out transform hover:border-fuchsia-300/50 hover:scale-110 hover:text-pink-2 flex flex-col justify-center items-center">
                ...
                <li className="p-2 border w-24 h-24 border-pink-3 transition duration-300 ease-in-out transform hover:border-fuchsia-300/50 hover:scale-110 hover:text-pink-2 flex flex-col justify-center items-center"><SiPhp className="h-12 w-12"/></li>
                <li className="p-2 border w-24 h-24 border-pink-3 transition duration-300 ease-in-out transform hover:border-fuchsia-300/50 hover:scale-110 hover:text-pink-2 flex flex-col justify-center items-center">
